/* LZOStream\LZOStream.cpp -- main implementation
...
#include "stdafx.h"
#include "LZOCommand.h"

int _tmain(int count, TCHAR** arguments)
{
    LZOCommand data;

    return data.Process(std::vector<LPCTSTR>(arguments + 1, arguments + count));
}
